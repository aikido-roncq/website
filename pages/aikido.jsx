...
const Aikido = () => (
  <Layout>
    ...
    <p className={styles.firstParagraph}>
      ...
      partenaire. Il s’adresse aux hommes et aux femmes, sans limite d’âge ni préparation
      spéciale. ✅
    </p>

    <p>
      Notre dojo suit les enseignements de l'académie autonome d'aïkido Kobayashi Hirokazu
      (aussi appelée <a href={LINKS.akh}>3aKH</a>), créée par{' '}
    ...
    <p>
      Le pratiquant étudie des principes de base propres aux arts martiaux : déplacements,
      esquives, saisies, distances. Il aborde progressivement le travail à mains nues
      (taijustu d’aiki), techniques d’immobilisations, de projections et également le
      travail des armes (aikijo et aikiken) dans le cadre du dojo.
    </p>
    ...
    <p>
      <a href={LINKS.akh}>3aKH</a> est une école traditionnelle qui est à l’origine de la
      création de nombreux dojos en France et de plusieurs académies à l’étranger. Elle
      forme des enseignants qui se tiennent à votre disposition pour vous présenter leur
      discipline.
    </p>
    ...
    <p>
      Depuis 2012, la <a href={LINKS.dnbk}>DNBK</a> reconnaît le Kobayashi Ryu Aïkido
      comme Budo Officiel dont André Cognard est nommé So-Shihan puis Soke en 2015. Il
      reçoit également le titre Samourai de <strong>Hanshi</strong> délivré par son
    ...
    <p>
      ...
      Transformant <strong>l'énergie</strong> de l'agression en énergie créative, cet art
      est aussi bien adapté pour les adultes que pour les enfants.
    </p>

    <p>
      Il respecte la nature et le rythme de chaque enfant, et procure à la fois détente et
      bien-être. Une meilleure gestion de l'énergie permet un <strong>équilibre</strong>{' '}
